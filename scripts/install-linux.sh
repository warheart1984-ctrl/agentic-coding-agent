#!/bin/bash
# Nova Linux Installer
# Installs Nova agentic coding system on Linux

echo "========================================"
echo "Nova Linux Installer"
echo "========================================"
echo ""
...
echo "========================================"
echo ""
echo "Please run 'source ~/.bashrc' or restart your terminal to use Nova."
